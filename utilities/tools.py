...
def generate_mask_uplft(input_image, window_shape, upper_left_points, gpu_number):   # saliency_map, crop_shape_adjusted, max_pos
    """
    ...
    """
    N, C, H, W = input_image.size()   # saliency_map
    ...
    if gpu_number is not None:
        ...
        device = torch.device("cuda:{}".format(input_image.get_device()))
